...
const Home = () => {
    ...
    useEffect(() => {
        ...
        axios({
            method: "get",
            url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=getOnExhibit',
            dataType: "JSON",
        ...
        axios({
            method: "get",
            url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=getToBeExhibit',
            dataType: "JSON",
            withCredentials: true
        })
            .then((res) => {
        ...
        axios({
            method: "get",
            url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=getBestCu',
            dataType: "JSON",
            withCredentials: true
        })
            .then((res) => {
        ...
        axios({
            method: "get",
            url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=getBestEx',
            dataType: "JSON",
            withCredentials: true
        })
            .then((res) => {
            ...
            <Row className='p-5 me-0'>
                ...
                <Row>
                    <Col className="d-flex justify-content-center">
                        <h3 className='hotCurator'><span style={{ color: '#e38970' }}> ★ </span> 熱門策展人 </h3>
                    </Col>
                    <Col className="d-flex justify-content-center">
                        <h3 className='hotExhibit'><span style={{ color: '#e38970' }}> ★ </span> 熱門展覽 </h3>
                    </Col>
                </Row>
                    ...
                    <Col lg='6'>
                        <div className='ratio ratio-16x9'>
                            <iframe width="560" height="315"
                                src="https://www.youtube.com/embed/C47K1TX9PAA"
