            ...
            .then((res) => {
                if (res.data.Login) { //使用者有登入
                    axios({ //getExhibitionListLogin
                        method: "get",
                        url: "http://360.systemdynamics.tw/backendPHP/Control.php?act=LoginExhibitionList",//name
                        dataType: "JSON",
                        withCredentials: true
                    })
                        .then((res) => {
                    ...
                    axios({
                        method: "get",
                        url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=getExhibitionList',
                        dataType: "JSON",
                        withCredentials: true
                    })
                        .then((res) => {
