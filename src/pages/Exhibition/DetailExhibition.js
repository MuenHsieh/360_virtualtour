...
const DetailExhitbition = () => {
  ...
  useEffect(() => {
    if (param1 > 0) {
      axios({
        method: "get",
        url: 'http://360.systemdynamics.tw/backendPHP/Control.php?act=checkUserCanView&eID=' + param1,
        dataType: "JSON",
        ...
        .then((res) => {
          if (res.data.canView) {
            ...
            axios({
              method: "get",
              url: "http://360.systemdynamics.tw/backendPHP/Control.php?act=getExhibitionData&eID=" + param1,
              dataType: "JSON",
              withCredentials: true
            })
              .then((res) => {
