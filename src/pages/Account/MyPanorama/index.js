...
const MyPanorama = () => {
    ...
    useEffect(() => {
        axios({
            method: "post",
            url: "http://360.systemdynamics.tw/backendPHP/Control.php?act=getMyPanoramaStatistics",
            dataType: "JSON",
    ...
    useEffect(() => {
        axios({
            method: "get",
            url: "http://360.systemdynamics.tw/backendPHP/Control.php?act=getMyPanoramaList",
            dataType: "JSON",
            withCredentials: true
        })
            .then((res) => {
