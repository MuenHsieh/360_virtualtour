...
const EditEx4 = (props) => {
    ...
    useEffect(() => {
        if ((phase === 4) && (data.mapImgFile !== null) && (mapIsLoad)) {
    ...
    }, [data.mapImgFile, phase, handleContextMenu, mapIsLoad]);
        ...
        <>
            ...
            <Row className='d-flex justify-content-center'>
                <Row className='w-75'>
                    ...
                    <Col>
                        <input type="file" name="mapImg" className="form-control mb-3" onChange={onFileChange} value={data.mapImg} accept="image/*,.jpg,.png" />
                    </Col>
                </Row>
                {
                    (data.mapImgFile !== "") && (data.mapImgFile) && (
                        (typeof data.mapImgFile === "string")
                            ? (
